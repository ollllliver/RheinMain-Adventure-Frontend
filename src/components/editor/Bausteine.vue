<template>
  ...
  <button class="btn btn-outline-secondary" draggable="true" @dragstart="startDrag($event, schluessel)" @click="setzeInfo(schluessel)" id="schluessel">
  <img src="/img/schluessel.png" style="display: block; margin-left: auto; margin-right: auto"/>
  </button>
  <button class="btn btn-outline-secondary" draggable="true" @dragstart="startDrag($event, npc)" @click="setzeInfo(npc)" id="npc">
  <img src="/img/npc.png" style="display: block; margin-left: auto; margin-right: auto"/>
  </button>
  <button class="btn btn-outline-secondary" draggable="true" @dragstart="startDrag($event, tuer)" @click="setzeInfo(tuer)" id="tuer">
