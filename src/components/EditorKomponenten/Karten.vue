<template>
  ...
  <div class="container" style="max-width: 600px">
    <div class="d-flex mt-5">
      <input v-model="karte" type="text" placeholder="Kartenname" class="form-control">
      <input v-model="kbeschreibung" type="text" placeholder="Kurzbeschreibung" class="form-control">
  ...
  <tbody>
    <tr v-for="(karte,index) in karten" :key="index">
      ...
      <td style="width:110px">
        <span @click="aendereStatus(index)" class="pointer"
          :class="{'text-danger':karte.status=='in Arbeit',
  ...
  methods:{
    ...
    submitName(){
      ...
      this.karten.push({
        name:this.karte,
        status:'in Arbeit',
        beschreibung:this.kbeschreibung,
      })
      }else{
